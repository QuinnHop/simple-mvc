...
const setDogName = (req, res) => {
  ...
  savePromise.then(() => {
    // set the lastDogAdded to our newest cat object.
    // This way we can update it dynamically
    lastDogAdded = newDog;
    // return success
    res.json({
...
// check if the dog exists, if it does, return it, otherwise tell user the dog doesn't exist
...
// check if dog exists, if it does, increase its age and return
